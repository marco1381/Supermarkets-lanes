    ...
    def run_simulation(self, total_simulation_duration, customer_generation_duration, display_status_interval):
        ...
        try:
            ...
            while current_time - start_time < total_simulation_duration:
                ...
                # Simulate checkout
                threading.Thread(target=self.simulate_checkout).start()
...
if __name__ == "__main__":
    # Main section to run the simulation
    regular_lane = regular_lanes
    self_service_lane = ss1
    lane_manager = LaneManager(regular_lane, self_service_lane)

    total_simulation_duration = 300  # Total simulation duration
    customer_generation_duration = 60  # Duration of customers generations
    display_status_interval = 30  # Display status every 30 seconds
    simulation = SupermarketSimulation(lane_manager)
    simulation.run_simulation(total_simulation_duration, customer_generation_duration, display_status_interval)
